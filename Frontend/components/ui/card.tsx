...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "line-panel flex flex-col gap-6 rounded-none text-card-foreground",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("leading-none text-lg font-semibold tracking-[-0.01em]", className)} {...props} />
}
