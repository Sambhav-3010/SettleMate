  ...
  return (
    <main className="app-shell min-h-[calc(100vh-4rem)]">
      <div className="mx-auto max-w-4xl space-y-4">
        <div className="line-panel flex items-center gap-3 p-4 md:p-6">
          <Link href="/dashboard">
          ...
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-[-0.02em] md:text-4xl">Profile Control</h1>
          </div>
        </div>
        ...
        <Card className="line-panel p-0">
          <CardHeader>
            ...
            <CardDescription>Update your username and UPI details used in settlements.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
